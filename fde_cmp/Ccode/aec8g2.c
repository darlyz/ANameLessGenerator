   ...
   .... num   ---- element no. */
{
    ...
    double eexx[25],eeyy[25],eezz[25],eeyz[25],eexz[25],eexy[25],eplast[25],eplastg[25];
...
l2:
        ...
        e[(1-1)*(3)+1-1]=+coefc[0*9+0]
        e[(1-1)*(3)+2-1]=+coefc[0*9+1]
        e[(1-1)*(3)+3-1]=+coefc[0*9+2]
        e[(2-1)*(3)+1-1]=+coefc[1*9+0]
        e[(2-1)*(3)+2-1]=+coefc[1*9+1]
        e[(2-1)*(3)+3-1]=+coefc[1*9+2]
        e[(3-1)*(3)+1-1]=+coefc[2*9+0]
        e[(3-1)*(3)+2-1]=+coefc[2*9+1]
        e[(3-1)*(3)+3-1]=+coefc[2*9+2]
        dev[1]=e[(1-1)*(3)+1-1];
        dev[2]=e[(2-1)*(3)+2-1];
        dev[3]=e[(3-1)*(3)+3-1];
        ...
        {
            iv=kvord[(i-1)*(3)+3-1];
            stif=+cv[(i-1)*(4)+4-1]+cw[(i-1)*(4)+3-1];
            eeyz[iv]+=stif;
        }
        for (i=1; i<=8; ++i)
        {
            iv=kvord[(i-1)*(3)+3-1];
            stif=+cu[(i-1)*(4)+4-1]+cw[(i-1)*(4)+2-1];
            eexz[iv]+=stif;
        }
        for (i=1; i<=8; ++i)
        {
            iv=kvord[(i-1)*(3)+2-1];
            stif=+cu[(i-1)*(4)+3-1]+cv[(i-1)*(4)+2-1];
            eexy[iv]+=stif;
        }
        for (i=1; i<=8; ++i)
        {
            iv=kvord[(i-1)*(3)+2-1];
            stif=(cu[(i-1)*(4)+2-1]*ddf[1]+cv[(i-1)*(4)+3-1]*ddf[2]+cw[(i-1)*(4)+4-1]*ddf[3]+(cv[(i-1)*(4)+4-1]+cw[(i-1)*(4)+3-1])*ddf[4]+(cu[(i-1)*(4)+4-1]+cw[(i-1)*(4)+2-1])*ddf[5]+(cu[(i-1)*(4)+3-1]+cv[(i-1)*(4)+2-1])*ddf[6]);
            eplast[iv]+=stif;
        }
        for (i=1; i<=8; ++i)
        {
            iv=kvord[(i-1)*(3)+2-1];
            stif=+cu[(i-1)*(4)+2-1]*ddg[1]+cv[(i-1)*(4)+3-1]*ddg[2]+cw[(i-1)*(4)+4-1]*ddg[3]+(cv[(i-1)*(4)+4-1]+cw[(i-1)*(4)+3-1])*ddg[4]+(cu[(i-1)*(4)+4-1]+cw[(i-1)*(4)+2-1])*ddg[5]+(cu[(i-1)*(4)+3-1]+cv[(i-1)*(4)+2-1])*ddg[6];
            eplastg[iv]+=stif;
        }
        // the following is the stif matrix computation
        for (iv=1; iv<=24; ++iv)
        {
            for (jv=1; jv<=24; ++jv)
            {
        ...
        for (iv=1; iv<=24; ++iv)
        {
            stif=-eexx[iv]*str[1]*vol
                 ...
                 -eexz[iv]*str[5]*vol
                 -eexy[iv]*str[6]*vol
                 +eplastg[iv]*b*prag*vol
                 +eexx[iv]*d[(1-1)*(3)+1-1]*qrev[(1-1)*(3)+1-1]*str[1]*dt
                 +eexx[iv]*d[(1-1)*(3)+1-1]*qrev[(1-1)*(3)+2-1]*str[2]*dt
                 +eexx[iv]*d[(1-1)*(3)+1-1]*qrev[(1-1)*(3)+3-1]*str[3]*dt
                 +eexx[iv]*d[(1-1)*(3)+2-1]*qrev[(2-1)*(3)+1-1]*str[1]*dt
                 +eexx[iv]*d[(1-1)*(3)+2-1]*qrev[(2-1)*(3)+2-1]*str[2]*dt
                 +eexx[iv]*d[(1-1)*(3)+2-1]*qrev[(2-1)*(3)+3-1]*str[3]*dt
                 +eexx[iv]*d[(1-1)*(3)+3-1]*qrev[(3-1)*(3)+1-1]*str[1]*dt
                 +eexx[iv]*d[(1-1)*(3)+3-1]*qrev[(3-1)*(3)+2-1]*str[2]*dt
                 +eexx[iv]*d[(1-1)*(3)+3-1]*qrev[(3-1)*(3)+3-1]*str[3]*dt
                 +eeyy[iv]*d[(2-1)*(3)+1-1]*qrev[(1-1)*(3)+1-1]*str[1]*dt
                 +eeyy[iv]*d[(2-1)*(3)+1-1]*qrev[(1-1)*(3)+2-1]*str[2]*dt
                 +eeyy[iv]*d[(2-1)*(3)+1-1]*qrev[(1-1)*(3)+3-1]*str[3]*dt
                 +eeyy[iv]*d[(2-1)*(3)+2-1]*qrev[(2-1)*(3)+1-1]*str[1]*dt
                 +eeyy[iv]*d[(2-1)*(3)+2-1]*qrev[(2-1)*(3)+2-1]*str[2]*dt
                 +eeyy[iv]*d[(2-1)*(3)+2-1]*qrev[(2-1)*(3)+3-1]*str[3]*dt
                 +eeyy[iv]*d[(2-1)*(3)+3-1]*qrev[(3-1)*(3)+1-1]*str[1]*dt
                 +eeyy[iv]*d[(2-1)*(3)+3-1]*qrev[(3-1)*(3)+2-1]*str[2]*dt
                 +eeyy[iv]*d[(2-1)*(3)+3-1]*qrev[(3-1)*(3)+3-1]*str[3]*dt
                 +eezz[iv]*d[(3-1)*(3)+1-1]*qrev[(1-1)*(3)+1-1]*str[1]*dt
                 +eezz[iv]*d[(3-1)*(3)+1-1]*qrev[(1-1)*(3)+2-1]*str[2]*dt
                 +eezz[iv]*d[(3-1)*(3)+1-1]*qrev[(1-1)*(3)+3-1]*str[3]*dt
                 +eezz[iv]*d[(3-1)*(3)+2-1]*qrev[(2-1)*(3)+1-1]*str[1]*dt
                 +eezz[iv]*d[(3-1)*(3)+2-1]*qrev[(2-1)*(3)+2-1]*str[2]*dt
                 +eezz[iv]*d[(3-1)*(3)+2-1]*qrev[(2-1)*(3)+3-1]*str[3]*dt
                 +eezz[iv]*d[(3-1)*(3)+3-1]*qrev[(3-1)*(3)+1-1]*str[1]*dt
                 +eezz[iv]*d[(3-1)*(3)+3-1]*qrev[(3-1)*(3)+2-1]*str[2]*dt
                 +eezz[iv]*d[(3-1)*(3)+3-1]*qrev[(3-1)*(3)+3-1]*str[3]*dt
                 +eeyz[iv]*shear*shearqrev*str[4]*dt
                 +eexz[iv]*shear*shearqrev*str[5]*dt
                 +eexy[iv]*shear*shearqrev*str[6]*dt
                 -eplastg[iv]*b*ddf[1]*qrev[(1-1)*(3)+1-1]*str[1]*dt
                 -eplastg[iv]*b*ddf[1]*qrev[(1-1)*(3)+2-1]*str[2]*dt
                 -eplastg[iv]*b*ddf[1]*qrev[(1-1)*(3)+3-1]*str[3]*dt
                 -eplastg[iv]*b*ddf[2]*qrev[(2-1)*(3)+1-1]*str[1]*dt
                 -eplastg[iv]*b*ddf[2]*qrev[(2-1)*(3)+2-1]*str[2]*dt
                 -eplastg[iv]*b*ddf[2]*qrev[(2-1)*(3)+3-1]*str[3]*dt
                 -eplastg[iv]*b*ddf[3]*qrev[(3-1)*(3)+1-1]*str[1]*dt
                 -eplastg[iv]*b*ddf[3]*qrev[(3-1)*(3)+2-1]*str[2]*dt
                 -eplastg[iv]*b*ddf[3]*qrev[(3-1)*(3)+3-1]*str[3]*dt
                 -eplastg[iv]*b*ddf[4]*shearqrev*str[4]*dt
                 -eplastg[iv]*b*ddf[5]*shearqrev*str[5]*dt
                 -eplastg[iv]*b*ddf[6]*shearqrev*str[6]*dt;
            eload[iv]+=stif*weigh;
        }
l999:
    return;
