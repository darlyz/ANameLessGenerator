...
void etestw4a(struct coordinates,int,int *,double *,struct element,struct matrice,double *);
void solv(struct matrice,double *);
void utestw4a(struct coordinates,int,int *,double *,double *);
int main (int argc, char *args[])
{
    if(argc>1)
    {
        ...
        {
            printf("version:3.0\n");
            printf("Time of release:2019-08-30 13:08:25\n");
    ...
    etestw4a(coor0,dofa,ida,ubfa,elema,matrixa,fa);
    solv(matrixa,fa);
    utestw4a(coor0,dofa,ida,ubfa,fa);
    gidres(coor0);
}
