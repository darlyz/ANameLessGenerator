...
def genxde(xdename, gesname, coortype):
    ...
    from src.felac_data import prepare_to_genxde
    prepare_to_genxde(gesname, coortype, ges_info)

    # parse xde
    from src.parse_xde import parse_xde
    ...
    # parse ges
    if gen_obj['ges'] > 0:
        from src.xde2ges import xde2ges_dict
    ...
    if gen_obj['ges'] > 0:
        from src.xde2ges import xde2ges
    ...
    if gen_obj['html'] > 0:
        from src.xde2html import xde2html
...
def command_help():
    from src.xde_help import auto_line_break_print
...
def main(argvs=None):
    ...
    if argvs[1] in ['-h', '--h', '-H', '--H', '-help', '--help']:
        ...
        if len(argvs) == 2 :
            ...
            from src.xde_help import xde_help
            xde_help(argvs[2])
    ...
    from src.felac_data import get_felac_data
    get_felac_data()
